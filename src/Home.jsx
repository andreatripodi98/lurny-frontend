    ...
    <div className="w-full bg-amber-50">
        ...
        <div className="max-w-7xl mx-auto p-8 rounded-xl bg-cyan-100 shadow-sm">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            ...
            <div className="p-8 rounded-xl bg-white shadow-sm hover:shadow-cyan-300 hover:shadow-lg">
              ...
              <p className="text-stone-800">
                Pick what you're doing (cooking, cleaning, gym…) and learn with{" "}
                <span className="text-indigo-600 font-bold hover:text-cyan-500">
                  contextual learning
                </span>.
              </p>
            </div>
      ...
      <section className="px-6 py-20 text-center">
        <h2 className="text-3xl font-bold mb-4">
          Start learning <span className="text-cyan-400">now</span>
        </h2>
